...
export class GetMicroDateGameResponseDto {
    ...
    @ApiProperty({ description: 'Game configuration and prompts', type: () => MicroDateGameConfig })
...
export const MICRO_DATE_GAMES: Record<string, {
    title: string;
    description: string;
    instructions: string;
    prompts?: string[];
    ...
    two_truths_lie: {
        ...
        instructions: 'Write down 2 truths and 1 lie about yourself. The other person will try to guess which one is the lie!',
        prompts: [
            'Statement 1',
            'Statement 2',
            'Statement 3',
    ...
    would_you_rather: {
        ...
        instructions: 'Choose your preference for each question. See how compatible you are!',
        options: [
    ...
    perfect_sunday: {
        ...
        instructions: 'Share what your perfect Sunday looks like. Let your match know your vibe!',
        prompts: [
            'Morning activity',
            'Afternoon plans',
            'Evening mood',
