  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          // ==================== FAQ ====================
          _buildSectionHeader(context, Icons.quiz_outlined, 'Frequently Asked Questions'),
          ...
          // ==================== CONTACT US ====================
          _buildSectionHeader(context, Icons.support_agent_outlined, 'Contact Us'),
          const SizedBox(height: 4),
          ...
          _buildSectionHeader(context, Icons.bug_report_outlined, 'Report a Bug / Feedback'),
